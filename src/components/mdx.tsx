...
const components = {
  ...
  blockquote: ({ ...props }) => (
    <blockquote
      className="relative rounded-sm border-l-4 border-slate-100/10 bg-slate-700/30 px-4 py-2 after:absolute after:right-1 after:top-0 after:text-3xl after:opacity-20 after:content-['❞']"
      {...props}
    />
  ),
  ...
  code: ({ ...props }) => (
    <code
      className="relative overflow-x-scroll rounded border px-2 py-1 font-mono text-sm sm:overflow-x-auto"
      {...props}
    />
  ),
